...
#define FS_REG_BASE     "SOFTWARE\\Lockheed Martin\\Prepar3D v4"
...
#define KEY_AXIS_STEERING_INC_SET                   (KEY_ID_MIN + 2506)
...
typedef struct  PANELS
{
    ...
    void        (FSAPI *register_var_by_name) ( PVOID var, VAR_TYPE var_type, LPSTR name );  
    void        (FSAPI *initialize_var) ( PMODULE_VAR module_var ); 
    void        (FSAPI *initialize_var_by_name) ( PMODULE_VAR module_var, LPSTR name );  
    void        (FSAPI *lookup_var) ( PMODULE_VAR module_var ); 
    void        (FSAPI *unregister_var_by_name) ( LPSTR name );  
    ...
    LPCSTR      (FSAPI *panel_resource_string_get) (ID32 id);   
    ...
    LPCSTR      (FSAPI *get_event_description) (ID32 event_id);
    LPCSTR      (FSAPI *get_event_token_string) (ID32 event_id);
